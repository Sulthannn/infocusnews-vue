...
<template>
    <section class="max-w-3xl mx-auto">
        <div class="bg-white rounded-2xl shadow-soft p-8">
            <h2 class="text-2xl font-bold mb-6 text-gray-800">Add News</h2>
            <form @submit.prevent="storeBerita" class="space-y-6">
                <div>
                ...
                <div>
                    ...
                    <input type="text" id="title" v-model="title" placeholder="Title Post" class="block w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent" required />
                ...
                <div>
                    ...
                    <input type="text" id="slug" v-model="slug" placeholder="Slug Post" class="block w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent" required />
                ...
                <div>
                    ...
                    <input type="text" id="excerpt" v-model="excerpt" placeholder="Excerpt Post" class="block w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent" required />
