        ...
        <div class="row">
            ...
            <div class="card border-0 rounded-lg shadow-lg">
                ...
                <form @submit.prevent="storeBerita">
                    ...
                    class="block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent"
                    required
                    />
                    ...
                    <div class="mb-6">
                        <label for="slug" class="block mb-2 text-gray-700 font-bold">
                    ...
                    <div class="mb-6">
                        <label for="excerpt" class="block mb-2 text-gray-700 font-bold">
                    ...
                    <div class="mb-6">
                        <label for="content" class="block mb-2 text-gray-700 font-bold">
